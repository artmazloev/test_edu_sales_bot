...
- **Настраиваемый голос** — голос покупателя задаётся per-scenario, темп речи регулируется (`YANDEX_TTS_SPEED`); слишком длинные голосовые (>30 c) вежливо отклоняются вместо ошибки
